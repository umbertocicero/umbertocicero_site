...
const I18n = (() => {
    ...
    const _dict = {
        ...
        it: {
            ...
            tut_step6:            '<strong>Vittoria Militare:</strong> conquista il 50% dei territori. <strong>Vittoria Economica:</strong> accumula 60.000 fondi controllando almeno il 30% della mappa. <strong>Vittoria Strategica:</strong> controlla tutti gli asset strategici globali. <strong>Vittoria Egemonica:</strong> dal turno 50 in poi, raggiungi almeno il 35% dei territori, con distacco di almeno 20 territori dal secondo. Attento all\'economia: senza risorse, crolla tutto.',
        ...
        en: {
            ...
            tut_step6:            '<strong>Military Victory:</strong> conquer 50% of territories. <strong>Economic Victory:</strong> accumulate 60,000 funds while controlling at least 30% of the map. <strong>Strategic Victory:</strong> control all global strategic assets. <strong>Hegemony Victory:</strong> from turn 50 onward, reach at least 35% of territories, with a lead of at least 20 territories over second place. Watch your economy: without resources, everything collapses.',
