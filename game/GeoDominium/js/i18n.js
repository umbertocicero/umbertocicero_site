...
const I18n = (() => {
    ...
    const _dict = {
        ...
        it: {
            ...
            tut_step3:            'Attacca nazioni nemiche: ogni unità ha ATK, DEF, velocità, raggio e costo. Il combattimento è probabilistico con bonus difensivi per le grandi potenze (+30% superpotenze). Attacchi multipli sullo stesso bersaglio ne logorano le difese. Conquista la patria nemica per un collasso totale! Puoi anche inviare spie (🕵️) o imporre sanzioni economiche.',
            ...
            tut_step6:            '<strong>Vittoria Militare:</strong> conquista il 40% dei territori. <strong>Vittoria Economica:</strong> accumula 45.000 fondi controllando almeno il 22% della mappa. <strong>Vittoria Strategica:</strong> controlla tutti gli asset strategici globali. <strong>Vittoria Egemonica:</strong> dal turno 35, raggiungi almeno il 28% dei territori con distacco di 15 dal secondo. <strong>Duopolio:</strong> se le prime 2 nazioni controllano >70% della mappa, chi è in testa vince. <strong>Punteggio:</strong> al turno 80 chi è in testa vince automaticamente.',
            ...
            vic_military_desc:    'Dominazione territoriale (≥40% territori)',
            vic_economic:         'VITTORIA ECONOMICA',
            vic_economic_desc:    'Supremazia economica (≥45K fondi + ≥22% territori)',
            ...
            vic_hegemony_desc:    'Supremazia schiacciante (≥28% territori, distacco 15, o duopolio >70%, o punteggio al T80)',
            ...
            ge_loots:                  'saccheggia',
            ge_war_spoils:             'bottino di guerra da',
            ge_attacks:                'attacca',
            ge_victory:                'VITTORIA',
            ge_defeat:                 'SCONFITTA',
            ...
            ge_rivalry_break:          'alleanza rotta — rivalità tra superpotenze!',
            ge_rivalry_war:            'guerra inevitabile tra potenze dominanti!',
        ...
        en: {
            ...
            tut_step3:            'Attack enemy nations: each unit has ATK, DEF, speed, range and cost. Combat is probabilistic with defense bonuses for great powers (+30% superpowers). Multiple attacks on the same target wear down its defenses. Conquer the enemy homeland for total collapse! You can also send spies (🕵️) or impose economic sanctions.',
            ...
            tut_step6:            '<strong>Military Victory:</strong> conquer 40% of territories. <strong>Economic Victory:</strong> accumulate 45,000 funds while controlling at least 22% of the map. <strong>Strategic Victory:</strong> control all global strategic assets. <strong>Hegemony Victory:</strong> from turn 35, reach at least 28% of territories with a 15-territory lead. <strong>Duopoly:</strong> if the top 2 nations control >70% of the map, the leader wins. <strong>Score:</strong> at turn 80 the leader wins automatically.',
            ...
            vic_military_desc:    'Territorial domination (≥40% territories)',
            vic_economic:         'ECONOMIC VICTORY',
            vic_economic_desc:    'Economic supremacy (≥45K funds + ≥22% territories)',
            vic_strategic:        'STRATEGIC VICTORY',
            vic_strategic_desc:   'Control of all strategic assets',
            vic_hegemony:         'HEGEMONY VICTORY',
            vic_hegemony_desc:    'Overwhelming supremacy (≥28% territories, 15 lead, or duopoly >70%, or score at T80)',
            ...
            ge_rivalry_break:          'alliance broken — superpower rivalry!',
            ge_rivalry_war:            'inevitable war between dominant powers!',
