...
const UNIT_TYPES = {
    ...
    navy:            {icon:'🚢',name:'Flotta Navale',    atk:14, def:10, cost:{money:300,steel:20,gold:2},              spd:3, rng:3},
    submarine:       {icon:'🐟',name:'Sottomarino',      atk:16, def:8,  cost:{money:280,steel:18,silver:2},            spd:2, rng:4},
    ...
    sam:             {icon:'📡',name:'Sistema SAM',      atk:5,  def:16, cost:{money:400,steel:20,rareEarth:3},         spd:0, rng:3},
...
const TECHNOLOGIES = [
    ...
    {id:'missile_defense',  icon:'📡',name:'Difesa Antimissile', cost:{money:1800,steel:40,rareEarth:10}, effect:'sam_def+10',            desc:'+10 DEF SAM',               prereq:[],                              tip:'Le batterie SAM difendono molto meglio dai missili.'},
...
const NATIONS = {
    ...
    ru:{name:'Russia',flag:'🇷🇺',color:'#b71c1c',profile:'superpower',
        ...
        assets:['arctic_route'],neighbors:['us','cn','ua','kz','fi','no','tr','ge','pl','by','ee','lv','lt','mn','az'],power:94},
    cn:{name:'Cina',flag:'🇨🇳',color:'#ff1a1a',profile:'superpower',
        res:{money:500,oil:30,gas:20,rareEarth:80,gold:18,silver:12,diamonds:0,uranium:10,steel:80,food:70},
        prod:{money:60,oil:5,gas:3,rareEarth:15,steel:15,food:10},
        army:{infantry:70,tank:28,fighter:18,bomber:8,drone:18,navy:14,submarine:10,sam:20,cruiseMissile:12,ballisticMissile:8},
        assets:['taiwan_strait'],neighbors:['ru','in','kr','kp','mn','kz','pk','mm','vn','la','np','bt','af','tj','kg'],power:98},
    ...
    jp:{name:'Giappone',flag:'🇯🇵',color:'#ec407a',profile:'defensive',
        ...
        army:{infantry:12,tank:6,fighter:10,bomber:2,drone:8,navy:10,submarine:6,sam:10,cruiseMissile:2},
        neighbors:['kr','tw','ph'],power:62},  /* island: main connections via sea */
    ...
    il:{name:'Israele',flag:'🇮🇱',color:'#5c6bc0',profile:'defensive',
        ...
        army:{infantry:14,tank:8,fighter:10,bomber:2,drone:10,navy:3,submarine:2,sam:10,cruiseMissile:4},
        neighbors:['eg','jo','sy','lb','ps'],power:52},
